...
description: "Adapts an external skill into project-specific development guidelines in .harness-cli/spec/. Creates guideline sections, code example templates with .template suffix, and updates spec indexes. Use when integrating an external skill, adding a new skill's patterns to project conventions, or incorporating third-party skill best practices into .harness-cli/spec/ documentation."
---

...
- [ ] Update `.harness-cli/spec/guides/` thinking guides
- [ ] Update `.harness-cli/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.harness-cli/spec/`, sync to `src/templates/markdown/spec/`

...
def get_check_context(repo_root: Path) -> list[dict]:
    ...
    entries = [
        {"file": adapter.get_harness_cli_command_path("finish-work"), "reason": "Finish work checklist"},
        {"file": adapter.get_harness_cli_command_path("check"), "reason": "Code quality check spec"},
    ]

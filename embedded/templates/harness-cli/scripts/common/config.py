#!/usr/bin/env python3
"""
Harness CLI configuration reader.

Reads settings from .harness-cli/config.yaml with sensible defaults.
"""
...
def get_spec_base(package: str | None = None, repo_root: Path | None = None) -> str:
    """Get the spec directory base path relative to .harness-cli/.

...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .harness-cli/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .harness-cli)
    if "/" in normalized or normalized.startswith(".harness-cli"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.harness-cli/tasks/test'): {is_safe_task_path('.harness-cli/tasks/test', repo)}")

...
You are the Check Agent in the Harness CLI workflow.
...
5. Read `.opencode/commands/hc/finish-work.md` for checklist
...
Read relevant specs in `.harness-cli/spec/` to check code:

...
Create a new slash command in both `.cursor/commands/` (with `harness-cli-` prefix) and `.opencode/commands/hc/` directories based on user requirements.
...
- `.opencode/commands/hc/<command-name>.md`

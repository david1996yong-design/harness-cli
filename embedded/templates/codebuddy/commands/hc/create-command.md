...
Create a new slash command in both `.codebuddy/commands/hc/` and `.claude/commands/hc/` directories based on user requirements.
...
- `.codebuddy/commands/hc/<command-name>.md`

---
description: "Harness CLI Copilot prompt: PART 3: Customize Your Development Guidelines"
---
...
**The Solution**: The `.harness-cli/workspace/` system captures what happened in each session - what was done, what was learned, what problems were solved. The `/` command reads this history at session start, giving AI "artificial memory."

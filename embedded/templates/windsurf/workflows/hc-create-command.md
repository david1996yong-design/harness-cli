---
description: Create a new Windsurf workflow in `.windsurf/workflows/harness-cli-<workflow-name>.md` based on user requirements.
---
...
```
/hc-create-command <workflow-name> <description>
```

**Example**:
```
/hc-create-command review-pr Check PR code changes against project guidelines
```
...
Create:
- `.windsurf/workflows/harness-cli-<workflow-name>.md`

### 5. Confirm Creation

Output result:
```
[OK] Created Workflow: /harness-cli-<workflow-name>

File paths:
- .windsurf/workflows/harness-cli-<workflow-name>.md

Usage:
/harness-cli-<workflow-name>
...
- Reference `.harness-cli/spec/frontend/index.md`

**Backend files** (`packages/api/`):
- Reference `.harness-cli/spec/backend/index.md`

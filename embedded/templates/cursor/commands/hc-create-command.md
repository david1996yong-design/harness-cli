...
Create a new slash command in both `.cursor/commands/` (with `harness-cli-` prefix) and `.claude/commands/hc/` directories based on user requirements.

## Usage

```
/hc-create-command <command-name> <description>
```
...
- `.cursor/commands/harness-cli-<command-name>.md`
- `.claude/commands/hc/<command-name>.md`

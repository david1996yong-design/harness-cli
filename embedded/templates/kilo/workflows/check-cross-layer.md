...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.harness-cli/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.harness-cli/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.harness-cli/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
| **`/hc:check-cross-layer`** (this) | Verification check | **After** implementation |
...
**Detailed Guide**: `.harness-cli/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.harness-cli/spec/guides/code-reuse-thinking-guide.md`
